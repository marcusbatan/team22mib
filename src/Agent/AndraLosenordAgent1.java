...
public class AndraLosenordAgent1 extends javax.swing.JFrame {
    ...
    public AndraLosenordAgent1(InfDB idb, String anvandarNamn) {
        initComponents();
    ...
    public AndraLosenordAgent1(InfDB idb) {
        initComponents();
        this.idb = idb;
    }
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AndraLosenordAgent1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
